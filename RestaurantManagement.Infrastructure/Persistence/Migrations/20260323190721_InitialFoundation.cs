        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservationAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_BranchId_NameEn",
                table: "Categories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrders_BranchId_PurchaseOrderNumber",
                table: "PurchaseOrders",
                columns: new[] { "BranchId", "PurchaseOrderNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReturns_BranchId_ReturnNumber",
                table: "PurchaseReturns",
                columns: new[] { "BranchId", "ReturnNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesReturns_BranchId_ReturnNumber",
                table: "SalesReturns",
                columns: new[] { "BranchId", "ReturnNumber" },
                unique: true);
